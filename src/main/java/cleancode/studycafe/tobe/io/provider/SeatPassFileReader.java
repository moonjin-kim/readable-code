...
public class SeatPassFileReader implements SeatPassProvider {
    private final String SEAT_PASS_LIST_PATH = "src/main/resources/cleancode/studycafe/pass-list.csv";
    @Override
    public StudyCafeSeatPasses getSeatPasses() {
        try {
            List<String> lines = Files.readAllLines(Paths.get(SEAT_PASS_LIST_PATH));
